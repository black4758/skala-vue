...
// 3 & 5. selectedCityInfo 감시 및 불쾌지수 알림
    ...
    <section class="search-section">
      <div class="search-box">
        ...
        <p class="search-result">
          입력한 도시 이름: <strong>{{ searchQuery || '없음' }}</strong>
        </p>
      </div>
    </section>
    ...
    <section class="list-section">
      ...
      <div v-if="displayWeatherList.length > 0" class="card-grid">
        <article
          ...
          :key="city.id"
          class="weather-card"
          :class="{ active: selectedCityInfo === city.name }"
        ...
        >
          ...
          <div class="card-body">
            ...
            <div
              ...
              style="margin-top: 8px; font-size: 0.8rem; color: #dc2626; font-weight: bold"
            >
      ...
      <!-- 선택된 도시 안내 바 -->
      <div class="selection-feedback" :class="{ selected: selectedCityInfo }">
        <p v-if="selectedCityInfo">
          📍 현재 선택한 지역: <strong>{{ selectedCityInfo }}</strong>
        </p>
        <!-- 변경된 기본 안내 문구 -->
